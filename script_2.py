# 3. Create const.py with constants
const_py_content = '''"""Constants for Custom Countdown Timer integration."""
...
with open(f"{base_dir}/custom_components/custom_countdown_timer/const.py", "w") as f:
    f.write(const_py_content)

print("Created const.py")