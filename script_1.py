# 2. Create __init__.py for the integration
init_py_content = '''"""Custom Countdown Timer integration for Home Assistant."""
...
with open(f"{base_dir}/custom_components/custom_countdown_timer/__init__.py", "w") as f:
